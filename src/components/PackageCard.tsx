  ...
  return (
    <div
      className={`bg-white rounded-2xl md:rounded-3xl p-6 sm:p-7 flex flex-col justify-between shadow-md hover:shadow-xl transition-all duration-300 border ${
        isFeatured ? 'border-[#C9A227] ring-2 ring-[#C9A227]/30 lg:-translate-y-2' : 'border-[#E8E0D2]'
      }`}
    >
      <div>
        {/* Top Badges & Duration */}
        <div className="flex items-center justify-between gap-2 mb-3">
          <span className="px-3 py-1 rounded-full bg-[#FAF7F2] border border-[#E8E0D2] text-[#444D47] text-xs font-semibold uppercase tracking-wider">
        ...
        {/* Thumbnail Preview */}
        <div className="h-44 w-full rounded-xl overflow-hidden relative mb-4 border border-[#E8E0D2]">
          <img
          ...
          <div className="absolute bottom-2.5 left-3 right-3 flex items-center justify-between text-white text-xs">
            ...
            <span className="bg-[#0F5132]/90 backdrop-blur-sm px-2.5 py-0.5 rounded-full font-bold">
        ...
        <h3 className="font-serif text-xl sm:text-2xl font-bold text-[#0F5132] leading-snug">
        ...
        <div className="mt-4 space-y-1.5">
          <div className="p-2.5 bg-[#FAF7F2] rounded-xl flex items-center justify-between text-xs border border-[#E8E0D2]">
            ...
            <span className="text-[#0F5132] font-semibold shrink-0 ml-2">
        ...
        <ul className="mt-5 space-y-2 text-xs sm:text-sm text-[#2C332E]">
          {packageItem.features[language].slice(0, 3).map((feat, idx) => (
      ...
      <div className="mt-6 pt-4 border-t border-[#E8E0D2]">
        <div className="flex items-baseline justify-between mb-4">
          ...
          <div className="text-right">
            <span className="font-serif text-2xl font-bold text-[#0F5132]">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-[#FAF7F2] hover:bg-[#EAF4EE] text-[#0F5132] font-semibold text-xs border border-[#0F5132]/30 text-center transition-colors"
          >
